  ...
  return (
    <Container className="py-16 space-y-8">
      ...
      <div>
        ...
        <p>
          जो व्यक्तिगत जानकारी आपसे प्रदान करने के लिए कहा जाता है, और इसके लिए
          आपसे क्यों पूछा जाता है, यह उस समय स्पष्ट किया जाएगा जब हम आपसे आपकी
          व्यक्तिगत जानकारी प्रदान करने के लिए कहेंगे।
        </p>
        <p>
          यदि आप हमसे सीधे संपर्क करते हैं, तो हम आपके बारे में अतिरिक्त जानकारी
          प्राप्त कर सकते हैं जैसे आपका नाम, ईमेल पता, फोन नंबर, संदेश और/या
          संलग्नक जो आप हमें भेज सकते हैं, और कोई अन्य जानकारी जो आप प्रदान करना
          चुन सकते हैं।
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            यह समझना और विश्लेषण करना कि आप हमारी वेबसाइट का कैसे उपयोग करते हैं
          </li>
      ...
      <div>
        ...
        <p>
          ...
          होस्टिंग सेवाओं के विश्लेषण का हिस्सा है। लॉग फ़ाइलों द्वारा एकत्र की
          गई जानकारी में इंटरनेट प्रोटोकॉल (IP) पतों, ब्राउज़र प्रकार, इंटरनेट
          सेवा प्रदाता (ISP), दिनांक और समय की मोहर, संदर्भ/निकासी पृष्ठ, और
          संभवतः क्लिक की संख्या शामिल होती है। यह जानकारी किसी भी व्यक्तिगत रूप
          से पहचान योग्य जानकारी से जुड़ी नहीं होती है। इसका उद्देश्य रुझानों का
          विश्लेषण करना, साइट का प्रशासन करना, वेबसाइट पर उपयोगकर्ताओं की
          गतिविधियों का ट्रैक करना और जनसांख्यिकी जानकारी एकत्र करना है।
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          करता है। इन कुकीज़ का उपयोग जानकारी संग्रहीत करने के लिए किया जाता है,
          जिसमें आगंतुकों की प्राथमिकताएं और उन पृष्ठों की जानकारी शामिल होती है
          जिन्हें आगंतुक ने वेबसाइट पर एक्सेस किया या देखा। यह जानकारी
      ...
      <div>
        ...
        <ul className="list-disc pl-8">
          <li>
            किसी व्यवसाय से अनुरोध करना जो उपभोक्ता का व्यक्तिगत डेटा एकत्र करता
            है, यह खुलासा करें कि वह कौन से व्यक्तिगत डेटा की श्रेणियाँ और
            विशिष्ट टुकड़े एकत्र कर चुका है।
          </li>
          <li>
            किसी व्यवसाय से अनुरोध करना कि वह उपभोक्ता के बारे में एकत्रित की गई
            कोई भी व्यक्तिगत जानकारी हटा दे।
          </li>
          <li>
            किसी व्यवसाय से अनुरोध करना जो उपभोक्ता का व्यक्तिगत डेटा बेचता है,
            वह उपभोक्ता का व्यक्तिगत डेटा न बेचे।
          </li>
        </ul>
        <p>
      ...
      <div>
        ...
        <p>
          हम यह सुनिश्चित करना चाहते हैं कि आप अपनी सभी डेटा संरक्षण अधिकारों से
          पूरी तरह से अवगत हैं। प्रत्येक उपयोगकर्ता के पास निम्नलिखित अधिकार
          हैं:
        </p>
        <ul className="list-disc pl-8">
          <li>
          ...
          <li>
            प्रसंस्करण को प्रतिबंधित करने का अधिकार – आपके पास यह अनुरोध करने का
            अधिकार है कि हम आपकी व्यक्तिगत डेटा के प्रसंस्करण को कुछ शर्तों के
            तहत प्रतिबंधित करें।
          </li>
          <li>
            प्रसंस्करण का विरोध करने का अधिकार – आपके पास हमारे द्वारा आपकी
            व्यक्तिगत डेटा के प्रसंस्करण का विरोध करने का अधिकार है, कुछ शर्तों
            के तहत।
          </li>
          <li>
            डेटा पोर्टेबिलिटी का अधिकार – आपके पास यह अनुरोध करने का अधिकार है
            कि हम जो डेटा एकत्रित किए हैं, उसे अन्य संगठन में स्थानांतरित करें,
            या सीधे आपको, कुछ शर्तों के तहत।
          </li>
        </ul>
        <p>
          यदि आप कोई अनुरोध करते हैं, तो हमारे पास आपको एक महीने के भीतर उत्तर
      ...
      <div>
        ...
        <p>
          ...
          करते हैं कि वे बच्चों की ऑनलाइन गतिविधियों को देखे, भाग लें और/या उनकी
          गतिविधियों को मार्गदर्शन करें।
        </p>
        <p>
          देव आरती संग्रह जानबूझकर 13 वर्ष से कम आयु के बच्चों से व्यक्तिगत
          पहचान योग्य जानकारी एकत्र नहीं करता है। यदि आपको लगता है कि आपके बच्चे
          ने हमारी वेबसाइट पर ऐसी जानकारी प्रदान की है, तो हमसे तुरंत संपर्क
          करने की सलाह देते हैं और हम इसे अपने रिकार्ड्स से हटा देने के लिए पूरी
          कोशिश करेंगे।
        </p>
      </div>
